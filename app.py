...
# Streamlit UI
st.title("Literature Search Crew")

# Input: Research Title
research_title = st.text_input("Enter Research Title:")
...
if research_title:
    ...
    if st.button("Kickoff Literature Search"):
        # Kickoff the crew with the input research title
        result = crew.kickoff(inputs={'research_title': research_title})

        st.header("Results")

        # Displaying results
        for task_result in result:
            st.subheader(task_result['task']['description'])
